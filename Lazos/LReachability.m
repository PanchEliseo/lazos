...
/**
 Metodo que se encarga de saber si el dispositivo tiene señal de wi fe conectada
 */
...
-(LReachability *)initWithReachabilityRef:(SCNetworkReachabilityRef)ref
{
    self = [super init];
    if (self != nil)
    {
...
-(NSString*)currentReachabilityString
{
	...
	if(temp == reachableOnWWAN)
	{
		...
		return NSLocalizedString(@"SPCellular", @"Cellular");
	}
	if (temp == ReachableViaWiFi)
	{
		return NSLocalizedString(@"SPWiFi", @"WiFi");
	}
    
	return NSLocalizedString(@"SPNoConnection", @"No Connection");
}
